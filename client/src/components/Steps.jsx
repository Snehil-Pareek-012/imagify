...
const Steps = () => {
    return (
        ...
        className='flex flex-col items-center justify-center my-32'>
            <h1 className='text-3xl sm:text-4xl font-semibold mt-2'>How it works ?</h1>

            <p className='text-lg text-gray-600 mb-5 mt-2 '>
                Transform your words into stunning images</p>
